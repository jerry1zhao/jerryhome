...
<body>
    ...
    <div class="main">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
					<div class="col-jerry-carousel">
						<div id="jerry-carousel--generic" class="carousel slide" data-ride="carousel">
							<!-- Indicators -->
							<ol class="carousel-indicators">
								<li data-target="#jerry-carousel--generic" data-slide-to="0"
									class="active"></li>
								<li data-target="#jerry-carousel--generic" data-slide-to="1"></li>
								<li data-target="#jerry-carousel--generic" data-slide-to="2"></li>
							</ol>

							<div class="carousel-inner" role="listbox">
								<#list postCaruosels as postCaruosel>
									<#if postCaruosel.id == 1>
                                    <div class="item active">
                                    	<a href="post/${postCaruosel.postId?c}">
											<img src="${postCaruosel.carouselImage}">
											<div class="carousel-caption">${postCaruosel.description}</div>
										</a>
									</div>
                                    <#else>
                                    <div class="item">
							...
							<!-- <a class="left carousel-control" href="#jerry-carousel--generic"
								role="button" data-slide="prev"> <span
								class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
								<span class="sr-only">Previous</span>
							</a> <a class="right carousel-control"
								href="#jerry-carousel--generic" role="button" data-slide="next">
